from sklearn.mixture import GaussianMixture  # 使用GMM高斯混合模型
import pandas as pd
import csv
...
# 用热力图呈现features_mean字段之间的相关性，实际上呈现的是英雄属性之间的相关性
...
# 最大攻速”这个属性值是百分数，不适合做矩阵运算，因此我们需要将百分数转化为小数。我们也看到“攻击范围”这个字段的取值为远程或者近战，
# 也不适合矩阵运算，我们将取值做个映射，用 1 代表远程，0 代表近战
...
# 构造GMM聚类,n_components高斯混合模型的个数，也就是聚类的个数
